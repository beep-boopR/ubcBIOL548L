...
bottom, shows raw data, how data are processed and analyzed, and then ultimately
delivers a strong punchline.
...
vignette, we will provide code that will create the **entire** figure. 
