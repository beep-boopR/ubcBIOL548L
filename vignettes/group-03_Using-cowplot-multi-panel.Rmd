...
### Figure 3 Panel D:
```{r panel_D, echo=FALSE, fig.height=2.16, fig.width=2.16,  warning=FALSE,message=FALSE}
...
### Figure 3 Panel E:
```{r panel_E, fig.height=2.16, fig.width=3.5, echo=FALSE, warning=FALSE,message=FALSE}
...
### Figure 3 Panel F:
```{r panel_F, echo=FALSE, fig.height=2.16, fig.width=3.5, warning=FALSE,message=FALSE}
...
```{r cow_BC, fig.height=3, fig.width=3}
...
```{r cow_D, fig.height=3, fig.width=3}
