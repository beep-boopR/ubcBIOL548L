...
# Gaede et al. 2017 data. (Can likely be parallelized, but we can do that later)
  ...
  file.copy(system.file("extdata", "Fig3F_data.csv",
            ...
            "./Fig3F_data.csv")
# Images  
  file.copy(system.file("extdata", "gaedeeatal_fig3.png",
              package = "ubcBIOL548L"),
            "./gaedeeatal_fig3.png")
...
This vignette is Part 3 of an R workshop created for 
[BIOL 548L](http://www.biology.ubc.ca/course-listing-2/#500level-4), a 
graduate-level course on data visualization taught through the 
[Biology Program](http://www.biology.ubc.ca/)
...
[Part 1's vignette](https://beep-boopr.github.io/ubcBIOL548L/articles/group-01.html) 
and 
...
We will use Figure 3 from Gaede et al. 2017 (Current Biology) as an example. 
...
![Figure 3 from Gaede et al. 2017](./gaedeeatal_fig3.png)
...
```{r panel_A, echo=FALSE, warning=FALSE,message=FALSE}
# First, import data
fig_A <-
...
### Figure 3 Panel B:
```{r panel_B, echo=FALSE, warning=FALSE,message=FALSE}
## Build the theme
...
```{r panel_C, echo=FALSE, warning=FALSE,message=FALSE}
...
plot_grid(fig_B, fig_B, fig_B, fig_B, fig_B,
          labels=c("1","2","3","4","5"))
plot_grid(fig_B, fig_B, fig_B, fig_B, fig_B, fig_B,
          labels=c("1","2","3","4","5","6"))
plot_grid(fig_B, fig_B, fig_B, fig_B, fig_B, fig_B, fig_B,
...
This looks horrible, but we're using extreme values here to emphasize what can
be adjusted.


## Assemble panels for each section of Fig 3
...
And there you have it! We have recreated the entire figure -- including 
annotations, icons, and inserted images -- all through code. 
